...
export const Footer = () => {
  return (
    <footer className="w-full bg-transparent text-black">
      <div className="max-w-7xl mx-auto px-4 py-6">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          ...
          <ul className="flex flex-wrap justify-center sm:justify-end items-center gap-4 md:gap-10 text-sm font-medium mb-2 sm:mb-0">
            ...
            <li>
              <Link href="#" className="text-black hover:underline">Nuestra clínica</Link>
            </li>
            <li>
              <Link href="#" className="text-black hover:underline">Especialidades</Link>
            </li>
            <li>
              <Link href="#" className="text-black hover:underline">Contacto</Link>
            </li>
          </ul>
