...
export default function SpecialityCard({ especialidad }: Props) {
  return (
    <article className="hover:translate-y-1 p-3.25 shadow-2xl transition duration-500 bg-white-200 rounded-2xl flex flex-col gap-3 border border-black-200 py-6 sm:flex-row sm:items-center sm:justify-between">
      <div>
